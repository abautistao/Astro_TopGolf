...
export const POST: APIRoute = async ({ request, locals }) => {
    ...
    const GOOGLE_SHEETS_URL = runtime?.env?.GOOGLE_SHEETS_REVIEWS_URL || import.meta.env.GOOGLE_SHEETS_REVIEWS_URL;
    ...
    const subjectData = `Nuevo Comentario: - ${data.get('Nombre Completo') || ''}`;
