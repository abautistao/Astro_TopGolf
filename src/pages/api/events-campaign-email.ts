...
export const POST: APIRoute = async ({ request, locals }) => {
    ...
    const GOOGLE_EVENTS_URL = runtime?.env?.GOOGLE_SHEETS_EVENTS_URL || import.meta.env.GOOGLE_SHEETS_EVENTS_URL;
    ...
    const subjectData = `Nuevo Lead Evento: - ${data.get('Nombre Completo') || ''}`;
