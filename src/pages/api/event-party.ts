...
export const POST: APIRoute = async ({ request, locals }) => {
    ...
    const GOOGLE_SHEETS_URL = runtime?.env?.GOOGLE_SHEETS_PARTY_URL || import.meta.env.GOOGLE_SHEETS_PARTY_URL;
    ...
    const subjectData = `Nuevo Lead Match Party: - ${data.get('Nombre Completo') || ''}`;
